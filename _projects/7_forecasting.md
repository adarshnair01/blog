...
### 2. Models Evaluated
   ...
   - **Ensemble**: The final solution was a weighted *ensemble* of Prophet and XGBoost.
...
-   **Solution**: Used Croston’s method (forecasting *interval* between sales and *size* of sale separately) for intermittent and lumpy demand patterns.
...
-   **Causal AI**: Using Causal Inference to better understand the *impact* of pricing changes ("If we raise price by 5%, how much will volume drop?") rather than just correlating them.
