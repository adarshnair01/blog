...
- **Explainable:** We can tell the user _why_ an item was recommended (e.g., "Because you liked other sci-fi movies").
...
- **Idea:** Find users who are similar to you, then recommend items that _they_ liked but _you_ haven't seen yet.
- **Process:**
...
- **Idea:** If you liked item A, find other items that are similar to item A based on how _other users_ have rated them. Then recommend those similar items.
- **Process:**
...
1.  **Offline Metrics:**
    ...
    - **Precision@k and Recall@k:** For item recommendation, these measure how many of the top _k_ recommendations are actually relevant, and how many relevant items were captured in the top _k_.
