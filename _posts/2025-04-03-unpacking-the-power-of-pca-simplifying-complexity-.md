...
- The corresponding **eigenvalues** tell us the _magnitude_ of the variance along those principal components. A larger eigenvalue means more variance (and thus more "information") is captured along that eigenvector's direction.
