...
1.  **Feature Selection:** We choose a _subset_ of the original features. Think of it as picking the best ingredients from your pantry and discarding the rest.
2.  **Feature Extraction:** We transform the original features into a _new, smaller set_ of features. This is like blending several ingredients to create a new, potent flavor.
...
- **Interpretability:** The new principal components are linear combinations of original features, which can sometimes make them harder to interpret directly (e.g., "PC1 is 0.3 _ feature1 - 0.7 _ feature2...").
...
- **t-SNE:**
  - **When:** Your primary goal is to _visualize_ high-dimensional data and uncover non-linear cluster structures. You're less concerned about the exact distances between widely separated clusters.
