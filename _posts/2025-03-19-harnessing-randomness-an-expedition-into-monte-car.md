...
Now, here's the Monte Carlo trick: **randomly throw darts** at the square dartboard. Assume every dart you throw lands _somewhere_ within the square, and each point within the square has an equal chance of being hit.
...
$$ \frac{\text{Number of darts inside circle}}{\text{Total number of darts}} \approx \frac{A*{circle}}{A*{square}} $$
...
2.  **Generate Random Inputs Over the Domain:** Using a random number generator, you pick samples from your defined domain. The quality of your random numbers (or more accurately, _pseudo-random_ numbers generated by computers) is crucial here.
